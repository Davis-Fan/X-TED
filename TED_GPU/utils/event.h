#ifndef CUDAPLAYGROUND_INCLUDE_EVENT_H_
#define CUDAPLAYGROUND_INCLUDE_EVENT_H_
#include <cassert>
#include <memory>
#include <utility>
...
class EventHolder : public IEvent {
 ...
 public:
  ...
  cudaEvent_t cuda_event() const override { return cuda_event_; }
};
...
class Event {
 ...
 public:
  ...
  Event(const Event& other) : internal_event_(other.internal_event_) {}
...
#endif  // CUDAPLAYGROUND_INCLUDE_EVENT_H_
