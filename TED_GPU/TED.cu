...
vector<vector<int>> standard_ted_1 (vector<string>& x_node, vector<vector<int>>& x_adj, vector<string>& y_node, vector<vector<int>>& y_adj, int num_threads, int parallel_version){
    ...
    switch (parallel_version) {
        ...
        case 18:{
            vector<vector<int>> result_18 = parallel_standard_ted_2_28(x_orl, x_kr, y_orl, y_kr, Delta_view, D_forest_2,D_tree_2, m, n, num_threads,x_adj,y_adj);
            result = result_18;
            break;
        }
        ...
        case 20:{
            ...
            vector<vector<int>> result_20 = parallel_standard_ted_Zhang(x_orl, x_kr, y_orl, y_kr, Delta_view, D_forest_2,D_tree_2, m, n, num_threads,x_adj,y_adj);
            result = result_20;
            break;
        ...
        case 28:{
            ...
            vector<vector<int>> result_28 = parallel_standard_ted_test_threshold(x_orl, x_kr, y_orl, y_kr, Delta_view, D_forest_2,D_tree_2, m, n, num_threads,x_adj,y_adj);
            result = result_28;
            break;
        ...
        case 36:{
            ...
            vector<vector<int>> result_36 = parallel_standard_ted_test(x_orl, x_kr, y_orl, y_kr, Delta_view, D_forest_2,D_tree_2, m, n, num_threads,x_adj,y_adj);
            result = result_36;
            break;
